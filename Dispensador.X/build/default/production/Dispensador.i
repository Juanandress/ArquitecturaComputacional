...
int main() {
    ...
    count=Leer_Pir(count);
    Estado_Sis(count);

    }
}
# 99 "Dispensador.c"
unsigned int Leer_Pir(int count) {
...
# 168 "Dispensador.c"
unsigned int Dips_Alcohol(int count) {
...
void Estado_Sis(int count){
    ...
    Lcd_Set_Cursor(1,10);
    Lcd_Write_String("Niv:");
    Lcd_Set_Cursor(2,1);
    Lcd_Write_String("15/12/2020");
   }
# 259 "Dispensador.c"
void Lcd_Port(char a){
